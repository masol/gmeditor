...
#ifndef  GME_UTILS_MODULEPATH_H
#define  GME_UTILS_MODULEPATH_H
...
class ModulePath : public Singleton<ModulePath> {
	private:
		...
		ModulePath() : m_initPath(boost::filesystem::gme_ext::resolve_sym( boost::filesystem::system_complete(boost::filesystem::initial_path<boost::filesystem::path>() ) ) )
		{
		}
	public:
		/**
